...
Public Property Get Filename() As String
    'aexcode: Filename Get property - retrieves "Filename" property.
...
Public Property Let Filename(fName As String)
    'aexcode: Filename Let property - allows it to be set.
    m_filename = fName
End Property

Public Property Get FileMode() As String
    'aexcode:FileMode Get property - allows it to be retrived
    FileMode = m_filemode
End Property

Private Property Get Filenumber() As Integer
    'aexcode: FileNumber property - allows it to be retrieved.
    Filenumber = m_handle
End Property

Private Property Let Filenumber(num As Integer)
    'aexcode: FileNumber property - allows it to be set.
    m_handle = num
End Property

Public Property Let FileMode(mode As String)
    'aexcode: FileMode property - allows it to be set. Includes basic validation.
...
Public Function WriteData(data As String)
    'aexcode: Function to write data to the file. Includes validation to stop it being written to a closed file, or one opened for read only access.
...
Public Function ReadData() As String
    'aexcode: Function to read data from a file and return it.
...
Public Function CloseFile()
    'aexcode: Function to close a file.
    Close #m_handle
    m_filemode = FileModeClosed
End Function

Private Sub Class_Initialize()
    'aexcode: Initialise feature for the class - will set things up as class is initialised.
    m_filemode = FileModeClosed ' closed - can't read or write
    m_handle = -1 ' invalid handle
End Sub

Public Function IsOpen() As Boolean
    'aexcode: Function to determine if a file is open or not.
    IsOpen = m_filemode <> FileModeClosed
End Function

Private Sub Class_Terminate()
    'aexcode: Function to tidy up on closing down the class.
    If Me.IsOpen Then Me.CloseFile
End Sub

Public Function AtEOF() As Boolean
    'aexcode: Function to determine if the file is at the end of the file.
    AtEOF = EOF(m_handle)
End Function